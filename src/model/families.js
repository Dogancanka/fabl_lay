...
export const FAMILY_SCHEMA = {
  ...
  clearSide: 'required free space at each side, m (kept clear of walls too — prevents corner-jamming)',
  wallGap: 'gap between the item back and the wall face, m (default 0 = flush)',
  endGap: 'minimum distance from wall-run ends / corners, m (default 0.05)',
...
export function normalizeFamily(raw) {
  ...
  return {
    ...
    wallGap: raw.wallGap !== undefined ? num(raw.wallGap, 'wallGap', 0, 1.5) : 0,
    endGap: raw.endGap !== undefined ? num(raw.endGap, 'endGap', 0, 2) : 0.05,
